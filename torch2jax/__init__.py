...
def t2j_array(torch_array):
  ...
  # we remove unit dims before conversion to work around https://github.com/jax-ml/jax/issues/25066
  return jax.dlpack.from_dlpack(torch_array.squeeze()).reshape(torch_array.shape)
